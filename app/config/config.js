...
export const primary_domain = "https://drippolifestyle.com";
export const admin_domain = "https://commerce.drippolifestyle.com";
...
export const default_path = "drippo";
...
export const db_start = "drippo_";
export const db_end = "_tbl";

export const drippo_header_key = "drippo-access-key";
export const drippo_header_token = "drippo-access-token";
