...
const top_logo = "https://res.cloudinary.com/dabfoaprr/image/upload/v1743441696/DLS-Sqaurred_tuhlwx.png";
const bottom_logo = "https://res.cloudinary.com/dabfoaprr/image/upload/v1743441696/DLS_cqeeyv.png";
	...
	const email_text = `
		...
		<body
			...
			<div class="container"
				...
				<h3 style="margin-bottom: 20px;">Dear ${data.user_name},</h3>
				<p style="margin-bottom: 10px;">Your order(s) with tracking number <a style="font-size: 15px; opacity: .7;" href="https://drippolifestyle.com/track/${data.tracking_number}">${data.tracking_number}</a> are getting ready to be processed. Please initiate your payment and complete the process to commence shipment.</p>
	...
	const email_text = `
		...
		<body
			...
			<div class="container"
				...
				<h3 style="margin-bottom: 20px;">Dear ${data.user_name},</h3>
				<p style="margin-bottom: 10px;">Payment for your order(s) with tracking number <a style="font-size: 15px; opacity: .7;" href="https://drippolifestyle.com/track/${data.tracking_number}">${data.tracking_number}</a> is due. Click on the button below to go to the payment page.</p>
	...
	const email_text = `
		...
		<body
			...
			<div class="container"
				...
				<h2 style="margin-bottom: 10px; opacity: .7;">Payment of ${data.currency} ${data.amount} is due</h2>
				<h3 style="margin-bottom: 20px;">Dear ${data.user_name},</h3>
				<p style="margin-bottom: 10px;">Payment for your order(s) with tracking number <a style="font-size: 15px; opacity: .7;" href="https://drippolifestyle.com/track/${data.tracking_number}">${data.tracking_number}</a> is due. Click on the button below to go to the tracking page to complete your payment.</p>
				<a href="https://drippolifestyle.com/track/${data.tracking_number}"
			style="display: inline-block; background-color: #2A52BE; color: #fff; padding: 10px 20px; border-radius: 5px; text-decoration: none; margin: 20px 0;">Pay now</a>
				<p style="margin-bottom: 10px;">Summary of your order(s) are shown below;</p>
			</div>
			<div class="container"
	...
	const email_text = `
		...
		<body
			...
			<div class="container"
				...
				<h3 style="margin-bottom: 20px;">Dear ${data.user_name},</h3>
				<p style="margin-bottom: 10px;">Payment for order(s) with tracking number <a style="font-size: 15px; opacity: .7;" href="https://drippolifestyle.com/track/${data.tracking_number}">${data.tracking_number}</a> has successfully been confirmed, we'll update you as
	...
	const email_text = `
		...
		<body
			...
			<div class="container"
				...
				<h3 style="margin-bottom: 20px;">Dear ${data.user_name},</h3>
				<p style="margin-bottom: 10px;">Your orders with tracking number <a style="font-size: 15px; opacity: .7;" href="https://drippolifestyle.com/track/${data.tracking_number}">${data.tracking_number}</a> has been cancelled successfully.</p>
	...
	const email_text = `
		...
		<body
			...
			<div class="container"
				...
				<h3 style="margin-bottom: 20px;">Dear ${data.user_name},</h3>
				<p style="margin-bottom: 10px;">Your orders with tracking number <a style="font-size: 15px; opacity: .7;" href="https://drippolifestyle.com/track/${data.tracking_number}">${data.tracking_number}</a> are on their way and will be with you soon.</p>
	...
	const email_text = `
		...
		<body
			...
			<div class="container"
				...
				<h3 style="margin-bottom: 20px;">Dear ${data.user_name},</h3>
				<p style="margin-bottom: 10px;">Your orders with tracking number <a style="font-size: 15px; opacity: .7;" href="https://drippolifestyle.com/track/${data.tracking_number}">${data.tracking_number}</a> has arrived at your destination.</p>
	...
	const email_text = `
		...
		<body
			...
			<div class="container"
				...
				<h3 style="margin-bottom: 20px;">Dear ${data.user_name},</h3>
				<p style="margin-bottom: 10px;">Your orders with tracking number <a style="font-size: 15px; opacity: .7;" href="https://drippolifestyle.com/track/${data.tracking_number}">${data.tracking_number}</a> has successfully been completed.</p>
	...
	const email_text = `
		...
		<body
			...
			<div class="container"
				...
				<h3 style="margin-bottom: 20px;">Dear ${data.user_name},</h3>
				<p style="margin-bottom: 10px;">Your order (${data.order_unique_id}) with tracking number <a style="font-size: 15px; opacity: .7;" href="https://drippolifestyle.com/track/${data.tracking_number}">${data.tracking_number}</a> has
